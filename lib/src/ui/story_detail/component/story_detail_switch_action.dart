              ...
              children: [
                Expanded(
                  child: RippleButton(
                    ...
                    backgroundColor: showDetailView ? AppColors.white : AppColors.transparent,
                    colorTitle: !showDetailView ? AppColors.white : AppColors.secondary2,
                  ),
                ),
                12.width,
                Expanded(
                  child: RippleButton(
                    ...
                    backgroundColor: showDetailView ? AppColors.transparent : AppColors.white,
                    colorTitle: showDetailView ? AppColors.white : AppColors.secondary2,
                  ),
                )
              ],

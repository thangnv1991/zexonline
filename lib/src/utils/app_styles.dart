...
class AppStyles {
  /// Title
  static fontSize18({Color color = AppColors.black, FontWeight fontWeight = FontWeight.w500}) =>
      GoogleFonts.cabin(fontSize: 18, color: color, fontWeight: FontWeight.w500);
